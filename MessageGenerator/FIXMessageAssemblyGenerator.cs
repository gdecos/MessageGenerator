...
{
    internal class FIXMessageAssemblyGenerator
    {
        ...
        public FIXMessageAssemblyGenerator() => new FIXMessageAssemblyGenerator(_filesBaseLocation);
        public FIXMessageAssemblyGenerator(string filesBaseLocation)
        {
        ...
        public void Run()
        {
            ...
            foreach (string file in files)
            {
                ...
                else
                {
                    ...
                    var entryPoint = AssemblyHelper.GetAllFIXDocumentTypes(assembly).First();
